...
include("../commons/latex/tables.jl")
...
# #   guidefontsize=14
# # )
# # plot!(initial_population[2], label=L"$\mathrm{I}_2(x)$", lw=2, ls=:dashdot)
# # plot!(initial_population[3], label=L"$\mathrm{I}_3(x)$", lw=2, ls=:dash)
...
# # """
# # mses = [
# #   mse(f.(data), initial_population[2].(data))
# #   mse(f.(data), initial_population[3].(data))
# #   mse(f.(data), O_1.(data))
# #   mse(f.(data), O_2.(data))
# # ]
