% | hyperref, varioref, cleveref - Enhanced cross-referencing in LaTeX
% |
...
% |
% | Note: 
% | Pay attention to the order of importing these packages, the recommended order is: hyperref, varioref, cleveref.
